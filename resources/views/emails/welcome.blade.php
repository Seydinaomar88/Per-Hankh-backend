...
<head>
    <meta charset="utf-8">
    <title>Bienvenue sur PER ANKH</title>
    <style>
...
<body>
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        <div class="container">
            <div class="header">
                <h1>Bienvenue sur PER ANKH</h1>
            </div>
            <div class="content">
                <h2>Bonjour {{ $user->name }},</h2>
                <p>Nous sommes ravis de vous accueillir sur <strong>PER ANKH</strong>, votre plateforme de gestion de projet collaborative.</p>
                <p>Vous pouvez dès maintenant :</p>
                <ul>
                    <li>Créer vos espaces de travail</li>
                    <li>Gérer vos tâches avec le tableau Kanban</li>
                    <li>Collaborer en temps réel avec votre équipe</li>
                </ul>
