...
<head>
    ...
    <style>
        ...
        .task-card { background-color: #f9fafb; border-left: 4px solid #EF4444; padding: 15px; margin: 15px 0; border-radius: 4px; }
    ...
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        <div class="container">
            ...
            <div class="content">
                ...
                <p>La tâche suivante n'a pas été terminée à temps :</p>
                ...
                <div class="task-card">
                    ...
                    <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                        <span class="badge" style="background-color: #EF4444; color: white;">
                          Date échue : {{ \Carbon\Carbon::parse($task->due_date)->format('d/m/Y') }}
                        </span>
                        @if($task->priority)
